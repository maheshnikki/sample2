...
import 'package:sample2/Models/cryptoTraning.dart';
import 'package:sample2/Widgets/AddingCrypto.dart';
...
class _HomeState extends State<Home> {
  ...
  void _add(String name, double amount, double percentage) {
    final addedCryto = Crypto(
      Name: name,
      amount: amount,
  ...
  void _AddCrypto(BuildContext cyp) {
    showModalBottomSheet(
        context: cyp,
        builder: (_) {
          return GestureDetector(
            onTap: () {},
            child: AddingCrypto(_add),
